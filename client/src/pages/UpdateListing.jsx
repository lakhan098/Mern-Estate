        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input onChange={handleChange} value={formData.regularPrice} type="number" id="regularPrice" min="100" max="10000000" required className="p-3 border border-gray-300 rounded-lg"/>
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    <input onChange={(e)=> setFiles(e.target.files)} className="p-3 border border-gray-300" type="file" name="" id="images" accept="image/*" multiple/>
                    <button disabled={imageLoading} type="button" onClick={ handleImageSubmit } className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">
                ...
                <button disabled={loading || imageLoading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80">
